...
@if(Session::has('success'))
    ...
    <div class="section__content section__content--p30" style="margin-top:-70px;">
        <div class="container-fluid">
            ...
            <br><br>
            <center>
                <form enctype="multipart/form-data" action="{{ route('postsignup') }}" method="POST" style="margin-top:-50px;">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input required accept="image/png, image/gif, image/jpeg" type="file" name="avatar_admin" id="exampleInputPassword1" value="" style="width:400px;">
