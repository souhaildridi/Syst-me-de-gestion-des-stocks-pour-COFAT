            ...
            <div class="dropdown text-end" style="margin-right: -40px;">
                <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <section style="width: 50px; height: 50px; margin-top: 20px;">
                        ...
                        <img  src="{{ asset(Auth::admin()->avatar_admin) }}" alt="mdo" class="rounded-circle">
                        

                    </section>
                </a> 
                <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                    <li><h6><a class="dropdown-item" href="#">{{ Auth::admin()->name }}</a></h6></li>
                    <li><a class="dropdown-item" href="#">{{ Auth::admin()->email }}</a></li>
