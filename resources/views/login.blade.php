...
<form class="login100-form validate-form" method="POST" style="height:440px;" action="{{ route('postlogin') }}">
@csrf
...
<span class="login100-form-title p-b-26" > User Login</span>
...
<div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" >
    ...
    <h1 style="font-size:30px; margin-left:-40px;">Hello User Welcome To Cofat Inventory Mangement </h1>
