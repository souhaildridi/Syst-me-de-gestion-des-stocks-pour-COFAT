...
@if(Session::has('success'))
    ...
    <div class="section__content section__content--p30" style="margin-top:-70px;">
        <div class="container-fluid">
            <h2 class="title-1 m-b-25" style="color:black; font-weight:bold;"><center>Modifier Produit</center> </h2><br>

            <center>
                <form enctype="multipart/form-data" action="{{ route('Product.update', $product->id) }}" method="post" style="margin-top:-50px;">
                    @csrf
                    @method('PUT')
                   
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-325px;">Nom Produit</label>
                        <input type="text" required class="form-control" name="title" id="exampleInputEmail1" placeholder="Enter Product Name" value="{{ $product->title  }}" style="width:400px;">
                        
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-295px;">Description</label>
                        <input type="text" required class="form-control" name="description" id="exampleInputEmail1" placeholder="Enter Description" value="{{ $product->description}}" style="width:400px;">

                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-290px;">Code Barre</label>
                        <input type="text" required class="form-control" name="product_code" id="exampleInputEmail1" placeholder="Enter Code Barre" value="{{ $product->product_code }}" style="width:400px;">

                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-290px;">Quantity in Stock</label>
                        <input type="text" required class="form-control" name="Quantite_En_Stock" id="exampleInputEmail1" placeholder="Enter Quantity in Stock" value="{{ $product->Quantite_En_Stock }}" style="width:400px;">

                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-290px;">Reference Article</label>
                        <input type="text" required class="form-control" name="reference_article" id="exampleInputEmail1" placeholder="Enter Reference d'article" value="{{  $product->reference_article  }}" style="width:400px;">

                    </div>
                    <!-- Continue for other form fields -->
                    <br>
                    <button type="submit" name="submit" class="btn btn-primary" style="margin-left:40px;">Submit</button>
                    <button type="reset" class="btn btn-secondary" style="margin-left:20px;"><i class="bi bi-x-square"></i><a href="{{ route('listeProduit') }}" style="color:white;"> Cancel</a></button> 
                </form>
            </center><br>
        </div>
    </div>
