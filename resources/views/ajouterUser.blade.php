...
@if(Session::has('success'))
    ...
    <div class="section__content section__content--p30" style="margin-top:-70px;">
        <div class="container-fluid">
            <h2 class="title-1 m-b-25" style="color:black; font-weight:bold;"><center>ajouter user</center></h2>
            
            <br><br>
            <center>
                <form enctype="multipart/form-data" action="{{ route('postsignupuser') }}" method="POST" style="margin-top:-50px;">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-325px;">Full Name</label>
                        <input type="text" required class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter Full Name" value="" style="width:400px;">
                     
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-295px;">Email address</label>
                        <input type="email" required class="form-control" name="email" id="exampleInputEmail1" placeholder="Enter email" value="" style="width:400px;">
                       
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-290px;">Phone Number</label>
                        <input type="text" required class="form-control" name="Tel_user" id="exampleInputEmail1"  placeholder="Enter Phone Number" value="" style="width:400px;">
                       
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="color:black;margin-left:-180px;">Department</label>
                        <select name="departement" id="cars" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" required class="form-control" name="password" id="exampleInputPassword1" placeholder="Password" value="" style="width:400px;">
                        
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" style="color:black;margin-left:-345px;">Avatar</label><br>
                        <input required accept="image/png, image/gif, image/jpeg" type="file" name="avatar_user" id="exampleInputPassword1" value="" style="width:400px;">
